...
const TIMELINE = [
  {
    year: "1964",
    title: "Established as a School",
    desc: "F.G. Degree College for Men, Peshawar Cantt was founded in 1964, initially operating as a school under the Cantonment education system, laying the foundation for what would later grow into a full degree-level institution.",
    icon: "🏛️",
    highlight: true,
  },
  {
    year: "1975",
    title: "Transferred to the Federal Ministry of Education",
    desc: "Following the \"Nationalization\" of Cantonment Boards' Educational Institutions, administrative control of the college was transferred to the Federal Ministry of Education, bringing it under direct federal oversight.",
    icon: "📜",
  },
  {
    year: "1977",
    title: "Shifted Under GHQ / Ministry of Defence",
    desc: "Control and management of the college were shifted to the General Headquarters (GHQ), placing the institution under the umbrella of the Ministry of Defence.",
    icon: "🏢",
  },
  {
    year: "1978",
    title: "Upgraded to Degree Level",
    desc: "The institution was formally upgraded from school to degree level, marking its transition into a full-fledged degree college and expanding the academic opportunities available to its students.",
    icon: "🎓",
    highlight: true,
  },
  {
    year: "1992",
    title: "Handed Over to the Ministry of Defence",
    desc: "All Federal Government Educational Institutions in Cantonments and Garrisons, including this college, were formally handed over to the Ministry of Defence, a structure that continues to this day.",
    icon: "🏛️",
  },
  {
    year: "Present",
    title: "Affiliation with NUP & Ongoing Excellence",
    desc: "Today, the college is managed by the Directorate of Federal Government Educational Institutions (Cantts/Garrisons) under the Ministry of Defence, and is affiliated with the National University of Pakistan (NUP), continuing its mission of providing quality higher education to the youth of Peshawar.",
    icon: "🌐",
    highlight: true,
  },
];
...
const ACHIEVEMENTS = [
  { icon: "🏅", title: "60+ Years of Service", desc: "Decades of continuous education in Peshawar Cantt since 1964." },
  ...
  { icon: "📜", title: "Ministry of Defence", desc: "Managed by the Directorate of Federal Government Educational Institutions (Cantts/Garrisons), under the Ministry of Defence." },
  { icon: "🔗", title: "University Affiliation", desc: "Affiliated with the National University of Pakistan (NUP) for degree-level programmes." },
];
...
const NOTABLE_FACTS = [
  ...
  { label: "Affiliation", value: "National University of Pakistan (NUP)" },
  { label: "Governing Body", value: "Directorate of FGEI (Cantts/Garrisons), Ministry of Defence" },
    ...
    <PageLayout icon="📜" title="History" breadcrumb="About FG → History" navigate={navigate}>
      ...
      <div className="history-banner" style={{
        ...
        <h2 style={{
          ...
          From a School in 1964 to a Federally Governed Degree College Affiliated with NUP
        </h2>
        ...
        <p style={{
          ...
          F.G. Degree College for Men, Peshawar Cantt was established in 1964, initially operating as a school. It was later upgraded to degree level, with its administration transferred to the Federal Ministry of Education and, eventually, to the Ministry of Defence. Today, the college is managed by the Directorate of Federal Government Educational Institutions (Cantts/Garrisons) and is affiliated with the National University of Pakistan (NUP).
        </p>
      </div>
      ...
      <div style={{ textAlign: "center", marginBottom: "44px" }}>
        ...
        <p style={{ fontSize: "15px", color: "#6b7280", maxWidth: "560px", margin: "0 auto", lineHeight: 1.7, fontFamily: "'DM Sans', sans-serif" }}>
          From a school in 1964 to a federally governed degree college affiliated with NUP — our story, milestone by milestone.
        </p>
      </div>
      ...
      <div style={{
        ...
        <p style={{
          ...
          From a school founded in 1964, through decades under federal and military administration, to an institution affiliated with NUP today — our history is not just our past, it is our promise.
        </p>
        ...
        <span style={{ fontSize: "13px", color: "#8a6a1a", fontFamily: "'DM Sans',sans-serif", fontWeight: 600, letterSpacing: "0.5px" }}>
          FG Degree College for Men, Peshawar — Est. 1964
        </span>
      </div>
